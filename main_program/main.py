...
class MainApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.loginWindow = LoginWindow(self.createRegistrationForm, self.createPredictionForm, self.setCurrentUser)
    ...
    def createLoginForm(self):
        loginWindow = LoginWindow(self.createRegistrationForm, self.createPredictionForm, self.setCurrentUser)
    ...
    def createPredictionForm(self):
        predictionWindow = PredictionWindow(self.createAccountForm, self.createLoginForm, self.clearCurrentUser, self.currentUser)
    ...
    def createAccountForm(self):
        accountWindow = AccountWindow(self.createLoginForm, self.createPredictionForm, self.clearCurrentUser, self.currentUser)
